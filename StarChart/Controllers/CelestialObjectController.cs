...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Update(int id, CelestialObject update)
        {
            var celestialObject = _context.CelestialObjects.Find(id);
            if(celestialObject == null)
            {
            ...
            celestialObject.Name = update.Name;
            celestialObject.OrbitalPeriod = update.OrbitalPeriod;
            celestialObject.OrbitedObjectId = update.OrbitedObjectId;
